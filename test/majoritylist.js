var NomineeQueue = artifacts.require("../contracts/NomineeQueue.sol");
...
contract('NomineeQueue', function(accounts) {
  it("should contain the first validator", function() {
    return NomineeQueue.deployed().then(function(instance) {
